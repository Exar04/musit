...
const AlbumsTable = () => {
	...
	return (
		<Table>
			<TableHeader>
				<TableRow className='hover:bg-zinc-800/50 text-white'>
					<TableHead className='w-[50px]'></TableHead>
					<TableHead className=" text-white">Title</TableHead>
					<TableHead className=" text-white">Artist</TableHead>
					<TableHead className=" text-white">Release Year</TableHead>
					<TableHead className=" text-white">Songs</TableHead>
					<TableHead className='text-right text-white'>Actions</TableHead>
				</TableRow>
			</TableHeader>
			<TableBody>
				{albums.map((album) => (
					<TableRow key={album._id} className='hover:bg-zinc-800/50 border-zinc-700 text-white'>
						<TableCell>
